    ...
    <footer id="contact" className="py-20 px-6 md:px-20 border-t border-gray-900 flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
      ...
      <div className="flex flex-col items-start md:items-end gap-4">
        <div className="flex gap-6">
          <a href="www.linkedin.com/in/nicolas-pasten-contreras-a9a114254" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-3 border border-gray-800 rounded-full hover:bg-white hover:text-black transition-colors" data-hover="true">
            <Linkedin size={24} />
          </a>
          <a href="https://www.behance.net/nicolaspasten3" target="_blank" rel="noopener noreferrer" aria-label="Behance" className="p-3 border border-gray-800 rounded-full hover:bg-white hover:text-black transition-colors" data-hover="true">
             <svg
